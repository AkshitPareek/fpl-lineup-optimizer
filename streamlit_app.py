...
def load_model_metrics():
    ...
    metrics_path = Path(__file__).parent / 'models/exp031_clean/metrics.json'
...
def load_experiment_results():
    ...
    results_dir = Path(__file__).parent / 'research/agents'
    results = []
...
def render_overview():
    ...
    exp032_path = Path(__file__).parent / 'models/exp032_fdr/model.pkl'
